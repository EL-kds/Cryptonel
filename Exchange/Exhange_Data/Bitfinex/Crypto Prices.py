...
class EosCoin_ToFiat_prices:
    def EOSUSDT(self):
        self.value = requests.get('https://api1.binance.com/api/v3/ticker/price?symbol=EOSUSDT')
        return self.value.json().get('price')                                                                                                        
CryptoPairs = {'tBTCUSD','tETHUSD','BNBUSDT','tBUSDUSD','tBCHN:USD','tADAUSD', 'tLINK:USD', 'tATOMUSD', 'CROUSDT', 'tDOGE:USD', 'tEOSUSD',
 'tFTTUSD', 'tIOTUSD', 'tLTCUSD', 'tXMRUSD', 'tXEMUSD', 'tDOTUSD', 'tXRPUSD', 'tSOLUSD', 'tXLMUSD', 'tTHETAUSD', 'tTRXUSD',
 'tVETUSD', 'tFILUSD','tUSTUSD', 'tSHIBUSD'}

print(type(CryptoPairs))